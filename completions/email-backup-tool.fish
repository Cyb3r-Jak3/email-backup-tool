...
function __email-backup-tool_perform_completion
    ...
    for line in $results
        if not string match -q -- "email-backup-tool*" $line
...
# Clear existing completions for email-backup-tool
complete -c email-backup-tool -e
# Register completion function
complete -c email-backup-tool -f -a '(__email-backup-tool_perform_completion)'
